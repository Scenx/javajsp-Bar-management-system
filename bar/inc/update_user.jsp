...
<div align="center">
<h3>修改密码</h3>
<form name="form1" method="post" action="inc/modify_password_save.jsp" target="_self" onSubmit="return Mycheck()">
...
<h3>修改其他信息</h3>
<form name="form2" method="post" action="inc/modify_info_save.jsp" >
...
<td width="33%" align="left"><input name="money" type="text" id="money" value="<%=sMoney%>" size="20">
...
<td width="37%" align="left"><input name="name" type="text" id="name" value="<%=User.getName()%>" size="20"></td>
</tr>
<tr>
<td width="7%" align="right" height="25">性别：</td>
<td height="25" colspan="3" align="left">目前你的性格为：<font style="color:#F00"><%=User.getSex()%></font> 修改请选择
<input type="radio" name="sex" value="男" <%if(User.getSex().compareTo("男") == 0)  out.println("checked");%> >
  男&nbsp;
...
<td width="37%" height="25" align="left"><input name="birth" type="text" id="birth" value="<%=User.getBirth()%>" size="20">
...
<td width="37%" height="25" align="left"><input name="address" type="text" id="address" value="<%=User.getAddress()%>" size="50" maxlength="400">
</tr>
<tr>
...
<td width="37%" height="11" align="left"><input name="tel" type="text" id="tel" value="<%=User.getTel()%>" size="20"></td>
</tr>
<tr>
  ...
  <td width="37%" height="12" align="left"><input name="safeanswer" type="text" id="safeanswer" value="<%=User.getSafeanswer()%>" size="50"></td>
</tr>
<tr>
