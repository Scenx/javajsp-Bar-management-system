...
<table width="686" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" bgcolor="#FFCCFF"><p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>此栏目仅<font style="color:#F00">注册用户</font>可以查看，如果您已经注册，请登录后再试，如果还没有账号请点击<a href="reg.jsp">注册</a>&hellip;&hellip;感谢您的使用</p>
      <p>&nbsp;</p>
      <p>如果您已经登录，出现了本页面，那么请返回<a href="index.jsp">首页</a>重新登录即可</p>
<p>&nbsp;</p>
    <p>&nbsp;</p>
<p>&nbsp;</p></td>
  </tr>
